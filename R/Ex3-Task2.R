...
dim(airlineDF2)
# make some room. With open-source R if we leave objects in our workspace # we will take up valuable memory for us and anyone else sharing the machine (e.g. 
# shared R server) 
rm(airlineDF)
gc()
...
cor(airlineDF2[, c('airSpeed', 'DepDelay', 'ArrDelay')], use = "na.or.complete")
